    ...
    public function actionCreate($recruitreqid)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()){
              ...
              $body = 'Semangat Pagi,,
              <br>
              Anda mendapatkan permintaan Approval STOP JO dengan rincian sebagai berikut :
              ...
              <td valign="top">:</td>
              <td valign="top">'.$modelrecreq->nojo.'</td>
              </tr>
              <tr>
              ...
              <td valign="top">:</td>
              <td valign="top">'.$model->oldjumlah.'</td>
              </tr>
              <tr>
              <td valign="top"> Jumlah Stop Pemenuhan Pekerja </td>
              <td valign="top">:</td>
              <td valign="top">'.$model->jumlahstop.'</td>
              </tr>
              <tr>
              <td valign="top"> Jumlah Kebutuhan </td>
              <td valign="top">:</td>
              <td valign="top">'.$model->jumlah.'</td>
              </tr>
              <tr>
              <td valign="top"> Alasan Stop</td>
              <td valign="top">:</td>
              <td valign="top">'.$alasanstop.'</td>
              </tr>
              <tr>
              <td valign="top"> Keterangan</td>
              <td valign="top">:</td>
              <td valign="top">'.$model->remarks.'</td>
              </tr>
              </table>
              <br>
              <br>

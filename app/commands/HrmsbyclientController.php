 ...
 * @since 2.0
 */
class HrmsbyclientController extends Controller
{
   ...
   */
  public function actionIndex($client = null, $start = 1, $limit = 1000)
  {
    /** Error reporting */

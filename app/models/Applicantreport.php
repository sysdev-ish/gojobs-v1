...
class Applicantreport extends Hiring
{
  ...
  public function rules()
  {
    return [
      ...
      [['education', 'havenpwp', 'applicantstatus', 'cityid', 'provinceid'], 'integer'],
      [['jurusan', 'registerstart', 'registerend', 'gender', 'maritalstatus', 'religion'], 'safe'],
    ];
  }
  ...
  public function search($params)
  {
    ...
    $dataProvider = new ActiveDataProvider([
      'query' => $query,
      'sort' => ['defaultOrder' => ['createtime' => SORT_ASC]]
    ]);

...
/**
 * Transrinciansearchfh represents the model behind the search form of `app\models\Transrincian`.
 */
class Transrinciansearchfh extends Transrincian
{
    public $jobfunc;
    public $jobfunclike;
    public $project;
    ...
    public function search($params)
    {
        ...
        $query->andWhere('trans_rincian_rekrut.status_rekrut = 1');
        $query->andWhere('YEAR(trans_jo.tanggal) >= '. date('Y') .' ');

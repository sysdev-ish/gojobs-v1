...
/**
 * Userinterviewsearch represents the model behind the search form of `app\models\Userinterview`.
 */
class Userinterviewsearch extends Userinterview
{
  public $fullname;
  public $city;
  public $jabatansap;
  ...
  public function rules()
  {
    return [
      ...
      [['createtime', 'updatetime', 'scheduledate', 'date', 'fullname', 'city', 'jabatansap','nojo'], 'safe'],
    ];
  }

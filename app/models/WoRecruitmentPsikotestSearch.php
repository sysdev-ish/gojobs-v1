...
/**
 * WoRecruitmentPsikotestSearch represents the model behind the search form of `app\models\WoRecruitmentPsikotest`.
 */
class WoRecruitmentPsikotestSearch extends WoRecruitmentPsikotest
{
    public $fullname;
    public $city;
    public $jabatansap;
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            // 'scheduledate' => date("$this->scheduledate"),
            'date' => $this->date,
            'psikotest.status' => $this->status,

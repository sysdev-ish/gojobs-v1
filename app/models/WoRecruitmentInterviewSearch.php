...
/**
 * WoRecruitmentInterviewSearch represents the model behind the search form of `app\models\WoRecruitmentInterview`.
 */
class WoRecruitmentInterviewSearch extends WoRecruitmentInterview
{
    public $fullname;
    public $jabatansap;
    public $city;
    ...
    public function rules()
    {
        return [
            ...
            [['createtime', 'updatetime', 'scheduledate', 'date', 'fullname', 'jabatansap', 'city'], 'safe'],
        ];
    }
    ...
    {
        $query = WoRecruitmentInterview::find();

...
/**
 * This is the model class for table "trans_rincian_rekrut".
 *
 * @property int $id
 ...
 * @property int $typejo
 */
class Transrincianrekrut extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['detail_komp', 'jumlah', 'skema', 'flag_jobs', 'flag_app', 'finish_view_manar', 'idpktable', 'typejo'], 'integer'],

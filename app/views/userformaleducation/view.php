...
<?php if (Yii::$app->utils->getlayout() == 'main') : ?>
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="userformaleducation-view box box-solid" style="padding: 10px;">
          ...
          <div class="careerfy-column-8">
            <div class="careerfy-employer-box-section">
              ...
              <div class="careerfy-description">
                ...
                <?php if ($model) {
                  echo  Html::a('Previous', ['/userfamily/views', 'userid' => $userid], [
                    'class' => 'btn btn-sm btn-default text-muted',
                    'data-toggle' => 'tooltip',
                    'data-placement' => 'bottom',
                    'title' => 'Previous',
                  ]);
                  echo  Html::a('Next', ['/usernonformaleducation/views', 'userid' => $userid], [

...
<div class="row">
  ...
  <div class="col-md-9">
<div class="userhealth-view box box-solid">
              ...
              <div class="careerfy-employer-box-section">
                ...
                <div class="careerfy-description">
                  <div class="box-body table-responsive no-padding">
                      ...
                      <div class="careerfy-candidate-title"> <h2><i class="careerfy-icon careerfy-user"></i> About you</h2> </div>
                      <?php if ($modelabout != '-'): ?>
                      <?= DetailView::widget([
                          'model' => $modelabout,
                          'template' =>'<tr><th width="30%" style="text-align:right;">{label}</th><td style="text-align:left;">{value}</td></tr>',
                      ...
                      <div class="careerfy-candidate-title"> <h2><i class="careerfy-icon careerfy-social-media"></i> Other people's opinions about you</h2> </div>
                    ...
                    <?php else : ?>
                      <span style="margin-left:30px;">No data..</span>
                    <?php endif; ?>
                      <div class="careerfy-candidate-title"> <h2><i class="careerfy-icon careerfy-design-skills"></i> Other people's opinions about you</h2> </div>
                      <?php if ($modelabout != '-'): ?>
                      <?= DetailView::widget([
                          'model' => $modelabout,
                          'template' =>'<tr><th width="30%" style="text-align:right;">{label}</th><td style="text-align:left;">{value}</td></tr>',

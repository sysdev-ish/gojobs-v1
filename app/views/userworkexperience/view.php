...
<?php if (Yii::$app->utils->getlayout() == 'main') : ?>
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="userworkexperience-view box box-solid" style="padding: 10px;">
        ...
        <div class="row">
          ...
          <div class="careerfy-column-8">
            <div class="careerfy-employer-box-section">
              ...
              <?php if ($model) {
                echo  Html::a('Previous', ['/userskill/views', 'userid' => $userid], [
                  'class' => 'btn btn-sm btn-default text-muted',
                  'data-toggle' => 'tooltip',
                  'data-placement' => 'bottom',
                  'title' => 'Previous',
                ]);
                echo  Html::a('Next', ['/organizationactivity/views', 'userid' => $userid], [

...
<?php if (Yii::$app->utils->getlayout() == 'main') : ?>
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="useremergencycontact-view box box-solid" style="padding: 10px;">
            ...
            <tbody>
              ...
              <?php foreach ($modelall as $key => $model) { ?>
                <tr>
                  ...
                  <td><?php echo $model->postalcode; ?></td>
          ...
          <div class="careerfy-column-8">
            <div class="careerfy-employer-box-section">
              ...
              <div class="careerfy-description">
                    ...
                    <?php foreach ($modelall as $key => $model) { ?>
                      <li class="careerfy-column-12" style="padding-bottom:50px;">
                        <div class="careerfy-resume-education-wrap">
                          ...
                          <span><?php echo $model->phone; ?> - <?php echo $model->address; ?>:<?php echo $model->postalcode; ?></span>
                        </div>
                      </li>
                    <?php } ?>
                  </ul>
                ...
                <?php if ($model) {
                  echo  Html::a('Previous', ['/organizationactivity/views', 'userid' => $userid], [
                    'class' => 'btn btn-sm btn-default text-muted',
                    'data-toggle' => 'tooltip',
                    'data-placement' => 'bottom',
                    'title' => 'Previous',
                  ]);
                  echo  Html::a('Next', ['/userreference/views', 'userid' => $userid], [

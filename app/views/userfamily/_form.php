                ...
                <div class="container-items"><!-- widgetBody -->
                  ...
                  <table class="table  table-striped" style="width:1525px;">
                    <tr>
					  ...
					  <th style="width:150px; text-align: center"><?= Yii::t('app', 'Gender') ?></th>
					  <th style="width:150px; text-align: center"><?= Yii::t('app', 'Birth place') ?></th>
					  <th style="width:150px; text-align: center"><?= Yii::t('app', 'Birth date') ?></th>
					  <th style="width:150px; text-align: center"><?= Yii::t('app', 'Last Education') ?></th>
					  ...
					  <th style="width:150px; text-align: center"><?= Yii::t('app', 'Remarks') ?></th>
                    ...
                    <tbody class="form-options-body">
                      <?php foreach ($modelfamily as $index => $modelfamily): ?>
                        <tr class="form-options-item">
                          ...
                          <td class="vcenter">
                            <?php
                            echo   $form->field($modelfamily, "[{$index}]relationship")->label(false)->widget(Select2::classname(), [
                          ...
                          <td class="vcenter">
                            <?= $form->field($modelfamily, "[{$index}]fullname")->label(false)->textInput(["maxlength" => true]) ?>
                          </td>
                          <td class="vcenter">
                            <?php
                            echo   $form->field($modelfamily, "[{$index}]gender")->label(false)->widget(Select2::classname(), [
                          ...
                          <td class="vcenter">
                            <?= $form->field($modelfamily, "[{$index}]birthplace")->label(false)->textInput(["maxlength" => true]) ?>
                          </td>
                          <td class="vcenter">
                            <?= $form->field($modelfamily, "[{$index}]birthdate")->label(false)->widget(
                            ...
                            <td class="vcenter">
                              <?php
                              echo   $form->field($modelfamily, "[{$index}]lasteducation")->label(false)->widget(Select2::classname(), [
                                'data' => $education,
                                'options' => ['placeholder' => '- select -'],
                                'pluginOptions' => [
                                  'allowClear' => true
                            ...
                            <td class="vcenter">
                              <?= $form->field($modelfamily, "[{$index}]jobtitle")->label(false)->textInput(["maxlength" => true]) ?>
                            </td>
                            <td class="vcenter">
                              <?= $form->field($modelfamily, "[{$index}]companyname")->label(false)->textInput(["maxlength" => true]) ?>
                            </td>
                            <td class="vcenter">
                              <?= $form->field($modelfamily, "[{$index}]description")->label(false)->textInput(["maxlength" => true]) ?>
                            </td>

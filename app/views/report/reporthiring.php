          ...
          $gridColumns = [
            ...
            [
              ...
              'value' => function ($data) {
                ...
                return ($data->recrequest) ? $data->recrequest->transjo->tanggal : "";
              }
            ],
            [
            ...
            [
              ...
              'format' => 'raw',
              'value' => function ($data) {
                return ($data->recrequest) ? (($data->recrequest->persa_sap) ? $data->recrequest->persa_sap : "") : "";
              }
            ],
            [
              'label' => 'Area (SAP)',
            ...
            [
              ...
              'format' => 'raw',
              'value' => function ($data) {
                return ($data->recrequest) ? (($data->recrequest->abkrs_sap) ? $data->recrequest->abkrs_sap : "") : "";
              }
            ],
            ...
            [
              ...
              'format' => 'raw',
              'value' => function ($data) {
                return ($data->recrequest) ? (($data->recrequest->jumlah) ? $data->recrequest->jumlah : "") : "";
              }
            ],
            [
            ...
            [
              ...
              'format' => 'raw',
              'value' => function ($data) {
                return ($data->recrequest) ? (($data->recrequest->kontrak) ? $data->recrequest->kontrak : "") : "";
              }
            ],
            [

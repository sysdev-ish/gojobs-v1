...
<div class="login-ajax" style="padding-top:10px">
        ...
        <div class="row" style="margin-top:10px;">
          ...
          <div class="col-xs-12">
            <?php echo Html::a('Sign in with HRIS', 'https://passport.ish.co.id/core/sso/default/login?response_type=code&client_id=GojobsDev&redirect_uri=http://192.168.88.170/rekrut/site/oauthhris&scope=user&action=login', ['class' =>  'btn btn-danger btn-block']) ?>
          </div>
        </div>

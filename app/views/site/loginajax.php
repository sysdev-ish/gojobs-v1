...
<div class="login-ajax" style="padding-top:10px">
        ...
        <div class="row" style="margin-top:10px;">
          ...
          <div class="col-xs-12">
            <?php echo Html::a('Sign in with HRIS', 'https://passport.ish.co.id/core/sso/default/login?response_type=code&client_id=goj0bsid&redirect_uri=https://gojobs.id/rekrut/site/oauthhris&scope=user&action=login', ['class' =>  'btn btn-danger btn-block']) ?>
          </div>
        </div>

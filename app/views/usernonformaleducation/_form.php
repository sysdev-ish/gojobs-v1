                ...
                <div class="container-items"><!-- widgetBody -->
                  ...
                  <table class="table  table-striped" style="width:100%;">
                      <tr>
                        ...
                        <th style="width:150px; text-align: center"><?= Yii::t('app', 'Certificate') ?></th>
                    ...
                    <tbody class="form-options-body">
                      ...
                      <tr class="form-options-item">
                        ...
                        <td class="vcenter">
                          <?php
                          echo   $form->field($modelnfedu, "[{$index}]type")->label(false)->widget(Select2::classname(), [
                        ...
                        <td class="vcenter">
                            <?= $form->field($modelnfedu, "[{$index}]institutions")->label(false)->textInput(["maxlength" => true]) ?>
                      </td>
                        <td class="vcenter">
                          <?= $form->field($modelnfedu, "[{$index}]startdate")->label(false)->widget(
                        ...
                        <td class="vcenter">
                          <?= $form->field($modelnfedu, "[{$index}]enddate")->label(false)->widget(
                            DatePicker::className(), [
                              'type' => DatePicker::TYPE_COMPONENT_APPEND,
                              'options' => ['class'=>'dob','placeholder' => 'Date'],
                              'removeButton' => false,
                        ...
                        <td class="vcenter">
                          <?php
                          echo   $form->field($modelnfedu, "[{$index}]iscertificate")->label(false)->widget(Select2::classname(), [
                            'data' => [ '1' => 'yes', '0' => 'no',],
                            'options' => ['placeholder' => '- select -'],
                            'pluginOptions' => [
                              'allowClear' => true

...
<div class="userforeignlanguage-search">
    ...
    <?php // echo $form->field($model, 'toefltest') ?>

    <?php // echo $form->field($model, 'toefltestplace') ?>

    <?php // echo $form->field($model, 'toefltestdate') ?>

    <?php // echo $form->field($model, 'toefltestscore') ?>

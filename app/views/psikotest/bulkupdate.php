  ...
  <div class="psikotest-form box box-primary">
    ...
    <div class="box-body table-responsive">
      <blockquote>
        ...
        <small>Job detail for
          <cite title="Source Title">
            <?//php echo (is_numeric($modelrecreq->jabatan)) ? $modelrecreq->jobfunc->jobcat->name_job_function_category . ' - ' . $modelrecreq->jobfunc->name_job_function : $modelrecreq->jabatan; ?>
          </cite>
        </small> -->
      </blockquote>

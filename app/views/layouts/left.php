        ...
        'items' => [
          ...
          [
            ...
            'items' => [
              ...
              ['label' => 'Industry Type', 'icon' => 'circle-o', 'url' => ['/industry/index'],'visible' => (Yii::$app->utils->permission($role,'m51')),
              'active' => Yii::$app->controller->id == 'industry'],
              ['label' => 'Job Family', 'icon' => 'circle-o', 'url' => ['/jobfamily/index'],'visible' => (Yii::$app->utils->permission($role,'m51')),
              'active' => Yii::$app->controller->id == 'jobfamily'],
              ['label' => 'Sub Job Family', 'icon' => 'circle-o', 'url' => ['/subjobfamily/index'],'visible' => (Yii::$app->utils->permission($role,'m51')),
              'active' => Yii::$app->controller->id == 'subjobfamily'],
              ['label' => 'Job Position Mapping', 'icon' => 'circle-o', 'url' => ['/jobmapping/index'],'visible' => (Yii::$app->utils->permission($role,'m51')),
              'active' => Yii::$app->controller->id == 'jobmapping'],
            ],
          ],

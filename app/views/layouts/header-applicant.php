...
<header id="careerfy-header" class="careerfy-header-one">
  <div class="container">
    <div class="row">
      <aside class="col-md-2"> <a href="#" class="careerfy-logo"><img style="max-width: 80%;" src="<?php echo $baseUrl; ?>/images/logo-gojobs-colour.png" alt=""></a> </aside>
      <!--<aside class="col-md-6">-->
      <aside <?php if(Yii::$app->check->datacompleted($userid) == 1) { ?> class="col-md-8" <?php } else { ?> class="col-md-7" <?php } ?>>
        <nav class="careerfy-navigation">
          ...
          <div class="collapse navbar-collapse" id="careerfy-navbar-collapse-1">
            <ul class="navbar-nav">
              ...
              <li class="<?php echo  (Yii::$app->controller->action->id == 'index') ? 'active ' : ' '; ?> "><?= Html::a(Yii::t('app', 'Home'), ['/site/index']) ?></li>
              <li class="<?php echo  (Yii::$app->controller->action->id == 'searchjob') ? 'active ' : ' '; ?>"><?= Html::a(Yii::t('app', 'Search Job'), ['/site/searchjob']) ?></li>
              <?php if(Yii::$app->check->datacompleted($userid) == 1) : ?>
                <li class="<?php echo  (Yii::$app->controller->id == 'userprofile') ? 'active ' : ' '; ?>"><?= Html::a('Profile', ['/userprofile/views','userid'=>$userid]) ?></li>
              <?php endif; ?>
              <li class="<?php echo  (Yii::$app->controller->action->id == 'contact') ? 'active ' : ' '; ?>"><?= Html::a(Yii::t('app', 'Contact'), ['/site/contact']) ?></li>
              <?php if(Yii::$app->check->datacompleted($userid) == 1) : ?>
			...
			<li>
				<ul class="careerfy-user-section">
				  ...
				  ?>	
				  <li><a href="<?php echo Yii::$app->request->baseUrl; ?>/site/setlang?lang=id"><?= Html::button('ID', ['id' => 'id', 'class' => $setLangid]) ?></a></li>
				  <li><a href="<?php echo Yii::$app->request->baseUrl; ?>/site/setlang?lang=en"><?= Html::button('EN', ['id' => 'en', 'class' => $setLangen]) ?></a></li>
				</ul>
			</li>
            ...
            <!--<li role="presentation" class="dropdown"> 
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> 
                <?php //echo Html::encode($setLang); ?> <span class="caret"></span> 
              </a> 
              <ul class="dropdown-menu"> 
                <li><a href="<?php //echo Yii::$app->request->baseUrl; ?>/site/setlang?lang=en">English</a></li> 
                <li><a href="<?php //echo Yii::$app->request->baseUrl; ?>/site/setlang?lang=id">Indonesia</a></li>
              </ul> 
            </li>-->
	  ...
	  <aside <?php if(Yii::$app->check->datacompleted($userid) == 1) { ?> class="col-md-2" <?php } else { ?> class="col-md-3" <?php } ?>>
        <div class="careerfy-right">
          <ul class="careerfy-user-section">
            <?php if(Yii::$app->user->isGuest): ?>
              <li><?= Html::button('Login', ['id' => 'loginButton', 'value' => \yii\helpers\Url::to(['site/login']), 'class' => 'btn btn-sm btn-primary']) ?></li>
              <li><?= Html::button('Register', ['id' => 'signupButton', 'value' => \yii\helpers\Url::to(['site/signup']), 'class' => 'btn btn-sm btn-primary-flip']) ?></li>

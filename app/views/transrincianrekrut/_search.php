...
/* @var $model app\models\Transrincianrekrutsearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="transrincianrekrut-search">
    ...
    <?php // echo $form->field($model, 'finish_view_manar') ?>

    <?php // echo $form->field($model, 'idtr') ?>

    <?php // echo $form->field($model, 'idtp') ?>

    <?php // echo $form->field($model, 'typejo') ?>
